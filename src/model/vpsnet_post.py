...
class VPSNetPost(nn.Module):
    ...
    def __init__(self, n_channels: int, sampling_factor: int, **kwargs) -> None:
        ...
        self.postprocessing_type = kwargs.get("postprocessing_type", 'spatial')
...
if __name__ == '__main__':
    upsampling = Upsampling(4, 4)
    downsampling = Downsampling(4, 4)
